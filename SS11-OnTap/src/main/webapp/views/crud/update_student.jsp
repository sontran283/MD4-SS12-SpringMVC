...
<div class="container">
    <h2>Edit Student</h2>
    <form method="post" action="<c:url value='/student/update' />">
        <input type="hidden" name="id" value="${student.studentCode}">
        ...
        <input type="checkbox" id="sex" name="sex" ${student.sex ? 'checked' : ''}>
